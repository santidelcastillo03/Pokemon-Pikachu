 ...
 * @author Angel
 */
public class PokemonSelect_1 extends javax.swing.JFrame {
    PokemonStatus1 pokemonStatus1 = new PokemonStatus1();
    PokemonStatus2 pokemonStatus2 = new PokemonStatus2();
    Game game = Game.getInstance();
    
    /**
     * Creates new form PokemonSelect
     */
    public PokemonSelect_1() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PokemonSelect_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PokemonSelect_1().setVisible(true);
            }
        });
    }
